...
* HirschmannScan: Broadcast (LLC) scanner, flash the device LED and edit the device
* OmronScan: Broadcast (UDP) scanner, TCP readout, stop/RUN PLC and retrieve (upload) program from PLC
